  ...
  return (
    <section className="bg-brand-primary py-12 relative z-20 shadow-2xl border-b border-brand-secondary/30">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 divide-white/10 md:divide-x md:divide-y-0 divide-y">
          {STATS.map((stat) => (
            <div key={stat.id} className="flex flex-col items-center justify-center p-6 md:p-8 text-center group hover:-translate-y-1 transition-transform duration-300">
